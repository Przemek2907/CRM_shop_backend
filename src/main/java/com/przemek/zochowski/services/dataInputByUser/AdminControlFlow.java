...
public class AdminControlFlow {
    ...
    private static final String option1 = "1. ADD OR UPDATE THE DATA IN THE SYSTEM LOADING IT FROM TXT FILES? (THE FILES FEEDING THE DATABASE WITH THE TABLES SHOULD BE PLACED IN THE RESOURCES FILE)";
    private static final String option2 = "2. LOAD THE DATA IN THE SYSTEM FROM THE JSON FILES";
    private static final String option3 = "3. GENERATE A REPORT WITH THE LIST OF PRODUCTS WITH THE MAXIMUM PRICE IN EACH CATEGORY?";
    private static final String option4 = "4. GENERATE A REPORT WITH THE LIST OF PRODUCTS ORDERED BY CLIENTS FROM THE COUNTRY AND AGE RANGE YOU SELECT?";
    private static final String option5 = "5. GENERATE A REPORT WITH THE LIST OF ALL THE PRODUCTS, WHICH HAVE A WARRANTY TYPE SELECTED BY YOU?";
    private static final String option6 = "6. GENERATE A REPORT WITH THE LIST OF SHOPS, WHICH HAVE PRODUCTS FROM A DIFFERENT COUNTRY THAN THE SHOP IS LOCATED IN?";
    private static final String option7 = "7. GENERATE A REPORT WITH THE LIST OF PRODUCERS ACTING IN THE BUSINESS BRANCH YOU HAVE SELECTED, WHO PRODUCED THE " +
            "AMOUNT OF STOCK, HIGHER THAN YOU SELECTED?";
    private static final String option8 = "8. GENERATE A REPORT WITH THE LIST OF ORDERS PLACED WITHIN SELECTED DATE RANGE AND OF A TOTAL VALUE (EXCLUDING DISCOUNT)?";
    private static final String option9 = "9. GENERATE A REPORT WITH THE LIST OF PRODUCTS ORDERED BY A SPECIFIC CUSTOMER?";
    private static final String option10 = "10. GENERATE A REPORT WITH THE LIST OF PRODUCTS MADE IN THE SAME COUNTRY AS THE MOTHER COUNTRY OF A CUSTOMER";
    ...
    private ReportsAboutCustomerOrders reportsAboutCustomerOrders = new ReportsAboutCustomerOrders();
   ...
   private void checkTheOption(){
        ...
        switch (choiceOption){
            case 1:
                ...
                break;
            case 2:
                dataInitializerFromFileService.initializeDataFromJson();
            case 3:
            ...
            case 7:
                ...
                break;
            case 8:
                dataManager.setLocalDate(ScannerService.getLocalDate("PLEASE PROVIDE THE DATE YOU WANT TO BEGIN YOUR SEARCH WITH(FORMAT: YYYY-MM-DD)"));
                dataManager.setLocalDateTo(ScannerService.getLocalDate("PLEASE PROVIDE THE DATE YOU WANT TO END YOUR SEARCH WITH(FORMAT: YYYY-MM-DD)"));
                dataManager.setOrderValue(ScannerService.getBigDecimal("PLEASE PROVIDE THE ORDER VALUE THRESHOLD"));
                reportsAboutCustomerOrders.getTheListOfOrdersFromSpecificPeriodAndAmount(dataManager.getLocalDate(), dataManager.getLocalDateTo(), dataManager.getOrderValue())
